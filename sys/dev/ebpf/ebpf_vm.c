...
static bool validate(const struct ebpf_vm *vm, const struct ebpf_inst *insts, uint32_t num_insts);
...
static bool
validate(const struct ebpf_vm *vm, const struct ebpf_inst *insts, uint32_t num_insts)
{
