...
static int
bad_map_update_elem(struct ebpf_map *em, void *key, void *value,
		    uint64_t flags)
{
	return EINVAL;
}
...
static void *
bad_map_lookup_elem(struct ebpf_map *em, void *key)
{
	return NULL;
}

static int
bad_map_lookup_elem_from_user(struct ebpf_map *em, void *key, void *value)
{
	return EINVAL;
}

static int
bad_map_delete_elem(struct ebpf_map *em, void *key)
{
	return EINVAL;
}

static int
bad_map_get_next_key(struct ebpf_map *em, void *key, void *next_key)
{
	return EINVAL;
}

static void
bad_map_deinit(struct ebpf_map *em)
{
	return;
}
