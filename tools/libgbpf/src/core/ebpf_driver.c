...
int
ebpf_load_prog(EBPFDriver *driver, uint16_t prog_type,
...
int
ebpf_map_update_elem(EBPFDriver *driver, int map_desc,
...
int
ebpf_map_lookup_elem(EBPFDriver *driver, int map_desc,
    void *key, void *value, uint64_t flags)
{
...
int
ebpf_map_get_next_key(EBPFDriver *driver, int map_desc,
