...
static int
ebpf_dev_load_prog(EBPFDriver *self, uint16_t prog_type,
...
static int
ebpf_dev_map_update_elem(EBPFDriver *self, int map_desc,
...
static int
ebpf_dev_map_lookup_elem(EBPFDriver *self, int map_desc,
    void *key, void *value, uint64_t flags)
{
  struct ebpf_dev_driver *driver = (struct ebpf_dev_driver *)self;
  union ebpf_req req;
...
static int
ebpf_dev_map_get_next_key(EBPFDriver *self, int map_desc,
