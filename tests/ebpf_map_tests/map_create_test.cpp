...
TEST(MapCreateTest, CreateWithNULLMapPointer)
{
  ...
  error = ebpf_map_init(NULL, EBPF_MAP_TYPE_ARRAY,
...
TEST(MapCreateTest, CreateWithInvalidMapType1)
{
  ...
  error = ebpf_map_init(&map, __EBPF_MAP_TYPE_MAX,
      sizeof(uint32_t), sizeof(uint32_t), 100, 0);
...
TEST(MapCreateTest, CreateWithInvalidMapType2)
{
  ...
  error = ebpf_map_init(&map, __EBPF_MAP_TYPE_MAX + 1,
      sizeof(uint32_t), sizeof(uint32_t), 100, 0);
